            ...
            tab = ::Spree::Admin::Tabs::TabBuilder.new(
                  ...
                  .with_availability_check(
                    lambda do |ability, resource|
                      ability.can?(:admin, ::Spree::Note) && ::SpreeNotes::Configuration.new[:noteables].include?('spree_products')
                    end
                  )
                  .build
...
::Spree::Admin::Tabs::ProductDefaultTabsBuilder.prepend(SpreeNotes::Spree::Admin::Tabs::ProductDefaultTabsBuilderDecorator)
